  ...
  const newDeck = new import_core.Deck({
    ...
    ...!props.gl && {
      deviceProps: {
        ...props.deviceProps,
        createCanvasContext: {
          ...typeof ((_a = props.deviceProps) == null ? void 0 : _a.createCanvasContext) === "object" ? props.deviceProps.createCanvasContext : void 0,
...
var GoogleMapsOverlay = class {
  constructor(props) {
    ...
    this._externalFramebuffer = null;
  ...
  setProps(props) {
    ...
    if (this._deck) {
      const parent = this._deck.props.parent || ((_a = this._deck.getCanvas()) == null ? void 0 : _a.parentElement);
  ...
  _onDrawVector({ gl, transformer }) {
    ...
    if (interleaved && deck.isInitialized) {
      ...
      if (device instanceof import_webgl.WebGLDevice) {
        const externalFbo = device.getParametersWebGL(36006);
        let _framebuffer = null;
        if (externalFbo) {
          if (((_a = this._externalFramebuffer) == null ? void 0 : _a.handle) !== externalFbo) {
            (_b = this._externalFramebuffer) == null ? void 0 : _b.wrapper.destroy();
