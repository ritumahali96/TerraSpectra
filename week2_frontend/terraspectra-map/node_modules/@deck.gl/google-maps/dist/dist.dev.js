    ...
    const newDeck = new import_core28.Deck({
      ...
      ...!props.gl && {
        deviceProps: {
          ...props.deviceProps,
          createCanvasContext: {
            ...typeof props.deviceProps?.createCanvasContext === "object" ? props.deviceProps.createCanvasContext : void 0,
    ...
    _onDrawVector({ gl, transformer }) {
      ...
      if (interleaved && deck.isInitialized) {
        ...
        if (device instanceof WebGLDevice) {
          const externalFbo = device.getParametersWebGL(GLEnum.FRAMEBUFFER_BINDING);
