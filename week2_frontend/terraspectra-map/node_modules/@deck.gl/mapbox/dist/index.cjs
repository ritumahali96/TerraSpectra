...
var MapboxOverlay = class {
  ...
  filterProps(props) {
    ...
    if (!this._interleaved && useDevicePixels !== void 0) {
  ...
  _onAddOverlaid(map) {
    ...
    this._deck = new import_core4.Deck({
      ...
      deviceProps: {
        ...
        createCanvasContext: {
          ...typeof ((_a = this._props.deviceProps) == null ? void 0 : _a.createCanvasContext) === "object" ? this._props.deviceProps.createCanvasContext : void 0,
