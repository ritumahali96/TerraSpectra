...
function getViewPropsFromCoordinateTransformer(map, coordinateTransformer) {
  var _getMapSize2 = getMapSize(map),
      width = _getMapSize2.width,
      height = _getMapSize2.height;

  var _coordinateTransforme = coordinateTransformer.getCameraParams(),
      latitude = _coordinateTransforme.lat,
      longitude = _coordinateTransforme.lng,
      bearing = _coordinateTransforme.heading,
      pitch = _coordinateTransforme.tilt,
      zoom = _coordinateTransforme.zoom;

  var fovy = 25;
  var aspect = height ? width / height : 1;
  var near = 0.75;
  var far = 300000000000000;
  var projectionMatrix = new _math.Matrix4().perspective({
