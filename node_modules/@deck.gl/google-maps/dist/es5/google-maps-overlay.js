  ...
  (0, _createClass2.default)(GoogleMapsOverlay, [{
    ...
    value: function _onDrawRaster() {
      ...
      var _getViewPropsFromOver = (0, _utils.getViewPropsFromOverlay)(this._map, this._overlay),
          ...
          zoom = _getViewPropsFromOver.zoom,
          pitch = _getViewPropsFromOver.pitch,
          latitude = _getViewPropsFromOver.latitude,
          longitude = _getViewPropsFromOver.longitude;
    ...
    key: "_onDrawVector",
    value: function _onDrawVector(gl, coordinateTransformer) {
      if (!this._deck || !this._map) {
        return;
      }

      var deck = this._deck;
      deck.setProps(_objectSpread({}, (0, _utils.getViewPropsFromCoordinateTransformer)(this._map, coordinateTransformer)));
