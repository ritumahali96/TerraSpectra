...
var CartoLayer = function (_CompositeLayer) {
  ...
  (0, _createClass2.default)(CartoLayer, [{
    ...
    value: function updateState(_ref) {
      ...
      var shouldUpdateData = changeFlags.dataChanged || props.connection !== oldProps.connection || props.geoColumn !== oldProps.geoColumn || JSON.stringify(props.columns) !== JSON.stringify(oldProps.columns) || props.type !== oldProps.type || JSON.stringify(props.credentials) !== JSON.stringify(oldProps.credentials);
    ...
    value: function () {
      var _updateData2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee() {
        var _this$props, type, source, connection, credentials, geoColumn, columns, localConfig, apiVersion, data;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _this$props = this.props, type = _this$props.type, source = _this$props.data, connection = _this$props.connection, credentials = _this$props.credentials, geoColumn = _this$props.geoColumn, columns = _this$props.columns;
