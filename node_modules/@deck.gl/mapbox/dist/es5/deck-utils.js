...
function drawLayer(deck, map, layer) {
  ...
  deck._drawLayers('mapbox-repaint', {
    ...
    layerFilter: function layerFilter(_ref2) {
      var deckLayer = _ref2.layer;
...
function afterRender(deck, map) {
  ...
  if (isExternal) {
    ...
    var hasNonMapboxLayers = deck.props.layers.some(function (layer) {
      return !mapboxLayerIds.includes(layer.id);
    });
