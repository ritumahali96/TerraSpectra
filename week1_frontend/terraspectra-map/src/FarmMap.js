...
// Generates 144 satellite pixels, with outbreak size/intensity growing over the given day offset
function generateRealisticSatelliteRaster(dayOffset) {
  ...
  // outbreak grows wider and more intense as days pass
...
export default function FarmMap() {
  ...
  // Rebuild the risk layer whenever the selected day changes
  useEffect(() => {
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', margin: 0, padding: 0 }}>
      ...
      <div style={{
        ...
        boxShadow: '0 4px 12px rgba(0,0,0,0.4)', zIndex: 10, fontFamily: 'sans-serif'
      }}>
      ...
      {hoverInfo && hoverInfo.object && (
        <div style={{
          ...
          boxShadow: '0 4px 10px rgba(0,0,0,0.5)', fontFamily: 'sans-serif',
      ...
      <div style={{
        ...
        boxShadow: '0 4px 12px rgba(0,0,0,0.3)', zIndex: 10, fontFamily: 'sans-serif'
      }}>
      ...
      {/* Timeline Slider - Week 4 addition */}
      <div style={{
        position: 'absolute', bottom: 24, right: 24, left: 280,
        background: 'rgba(15, 23, 42, 0.92)', color: 'white',
