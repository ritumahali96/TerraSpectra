...
import numpy as np # Needed for create_patches and initial data handling
...
# Assuming cube_pca_rasterio and gt are defined in the execution environment
# (e.g., from running Week 1 pipeline)
